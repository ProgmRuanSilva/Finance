 ...
 */
export declare type StyleValueWithSequenceArraysWithoutTransform<T, Key extends keyof T = keyof T, KeyWithoutTransform extends Exclude<Key, 'transform'> = Exclude<Key, 'transform'>> = {
    [key in KeyWithoutTransform]: T[KeyWithoutTransform] | SequenceItem<T[KeyWithoutTransform]>[];
};
...
export interface MotiProps<AnimateType = ImageStyle & TextStyle & ViewStyle, AnimateWithTransitions = StyleValueWithReplacedTransforms<AnimateType>, Animate = StyleValueWithSequenceArrays<AnimateWithTransitions>> {
     ...
     * */
    exit?: AnimateWithTransitions | boolean | ((custom?: any) => AnimateWithTransitions);
    /**
     ...
     *
     */
    exitTransition?: MotiTransitionProp<AnimateWithTransitions> | ((custom?: any) => MotiTransition<AnimateWithTransitions>);
    /**
...
export declare type UseDynamicAnimationState = {
    /**
     * @private
     ...
     * @worklet
     */
    animateTo: (key: DynamicStyleProp | ((currentState: DynamicStyleProp) => DynamicStyleProp)) => void;
};
export {};
